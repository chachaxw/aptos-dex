...
- **项目负责人**：负责整体架构设计和项目管理
- **智能合约开发**：Move 语言专家，负责链上合约开发
- **后端开发**：Rust 专家，负责匹配引擎和 API 开发
- **前端开发**：React/Next.js 专家，负责用户界面开发
- **区块链集成**：Aptos 生态专家，负责区块链集成和优化

## 演示视频/截图

### 在线演示
- **测试网地址**：https://hyperperp-demo.vercel.app
- **合约地址**：`0x...`（部署后更新）
